...
2. 再看 ingest backlog，理解知识层资产现状与历史批次。
3. 最后看最近一份 work log，理解上一轮实际完成情况与项目进度。
...
2. 按 `M1 -> M2 -> M3 -> M4` 理解后续迭代顺序
3. 再回看 `memory/knowledge-ingest-backlog.md`，只把 ingest 作为按需补洞来源
