...
export default function NewReadingPage() {
  return (
    <main className="new-reading-workspace relative mx-auto flex w-full max-w-[1500px] flex-col px-4 py-3 sm:px-5 lg:h-[calc(100dvh-4rem)] lg:overflow-hidden lg:px-6 max-lg:min-h-[calc(100dvh-4rem)] max-lg:overflow-y-auto max-lg:pb-28">
